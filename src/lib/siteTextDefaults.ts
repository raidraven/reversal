...
export const DEFAULT_SITE_TEXT: Record<string, string> = {
  ...
  "landing.companionUpdateNote": "この館も少しずつ手を加えております。何か気になることがあれば、遠慮なく主催者への要望からお申し付けくださいませ。",
  "login.title": "扉の前で",
  "login.subtitle": "すでに登録済みの方はこちらから",
  ...
  "admin.section.socialDrafts": "X投稿の下書き管理",
  "admin.section.analytics": "アクセス状況(GA4)",
  "admin.section.analyticsDescription": "直近28日間のユーザー数・PV数・人気ページ",
...
export const SITE_TEXT_LABELS: Record<string, string> = {
  ...
  "landing.companionUpdateNote": "ランディングページのクロエによるお知らせ文言",
  ...
  "admin.section.socialDrafts": "管理ページ「X投稿の下書き管理」セクションの見出し",
  "admin.section.analytics": "管理ページ「アクセス状況(GA4)」セクションの見出し",
  "admin.section.analyticsDescription": "管理ページ「アクセス状況(GA4)」セクションの説明文",
