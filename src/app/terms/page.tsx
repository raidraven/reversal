    ...
    <main className="mx-auto max-w-2xl px-4 py-12">
      <div className="game-card space-y-6 text-sm leading-relaxed text-stone-300">
        <div className="text-center">
          ...
          <h1 className="mansion-title mt-2 text-2xl">利用規約</h1>
          <p className="mt-1 text-xs text-stone-500">最終改定日: 2026年7月15日</p>
        </div>

        <div className="whitespace-pre-wrap">
          <EditableText siteTextKey="terms.content" value={texts["terms.content"]} multiline />
        </div>
